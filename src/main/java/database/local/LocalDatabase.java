...
public class LocalDatabase implements MovieDatabaseInterface {
    ...
    private static void load(){
        ...
        entities.add(EntityBuilder.builder()
                ...
                .FINGERPRINT(FingerprintBuilder.builder().BLOOD(7).HAPPY(1).HORROR(10).ACTION(2).ART(8).LOVE(0).COMEDY(1).FANTASY(0).Experience(10).STORY(6).build().generate())
        ...
        entities.add(EntityBuilder.builder()
                ...
                .FINGERPRINT(FingerprintBuilder.builder().BLOOD(7).HAPPY(6).HORROR(7).ACTION(7).ART(7).LOVE(5).COMEDY(3).FANTASY(2).Experience(9).STORY(5).build().generate())
        ...
        entities.add(EntityBuilder.builder()
                ...
                .FINGERPRINT(FingerprintBuilder.builder().BLOOD(0).HAPPY(7).HORROR(0).ACTION(8).ART(6).LOVE(10).COMEDY(9).FANTASY(6).Experience(5).STORY(7).build().generate())
